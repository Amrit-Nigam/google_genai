...
const mockCareerPaths = {
  'software-developer': {
    nodes: [
      ...
      { id: '9', type: 'skill' as const, title: 'AWS', description: 'Cloud computing and deployment', position: { x: 500, y: 300 } },
    ],
    edges: [
      ...
      { id: 'e4-9', source: '4', target: '9', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
    ]
  },
  'data-scientist': {
    nodes: [
      ...
      { id: '2', type: 'course' as const, title: 'Data Analysis', description: 'Pandas, NumPy, and data manipulation', duration: '3 months', difficulty: 'intermediate' as const, position: { x: 300, y: 100 } },
      { id: '3', type: 'course' as const, title: 'Machine Learning', description: 'Scikit-learn and ML algorithms', duration: '4 months', difficulty: 'advanced' as const, position: { x: 500, y: 100 } },
      { id: '4', type: 'internship' as const, title: 'Data Science Intern', description: 'Work on real-world data projects', duration: '6 months', position: { x: 700, y: 100 } },
      { id: '5', type: 'job' as const, title: 'Data Scientist', description: 'Build ML models and analyze data', salary: '$80k-110k', position: { x: 900, y: 100 } },
      { id: '6', type: 'company' as const, title: 'Netflix', description: 'Recommendation systems and analytics', position: { x: 1100, y: 100 } },
      { id: '7', type: 'skill' as const, title: 'SQL', description: 'Database querying and management', position: { x: 100, y: 300 } },
      { id: '8', type: 'skill' as const, title: 'TensorFlow', description: 'Deep learning framework', position: { x: 300, y: 300 } },
      { id: '9', type: 'skill' as const, title: 'Statistics', description: 'Statistical analysis and hypothesis testing', position: { x: 500, y: 300 } },
    ],
    edges: [
      { id: 'e1-2', source: '1', target: '2', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      { id: 'e2-3', source: '2', target: '3', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      ...
      { id: 'e5-6', source: '5', target: '6', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      { id: 'e1-7', source: '1', target: '7', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
      { id: 'e3-8', source: '3', target: '8', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
      { id: 'e2-9', source: '2', target: '9', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
    ]
  },
  'product-manager': {
    nodes: [
      ...
      { id: '2', type: 'course' as const, title: 'Product Strategy', description: 'Product roadmap and planning', duration: '3 months', difficulty: 'intermediate' as const, position: { x: 300, y: 100 } },
      { id: '3', type: 'course' as const, title: 'User Research', description: 'Understanding user needs and behavior', duration: '2 months', difficulty: 'intermediate' as const, position: { x: 500, y: 100 } },
      { id: '4', type: 'internship' as const, title: 'Product Intern', description: 'Work on product features and strategy', duration: '6 months', position: { x: 700, y: 100 } },
      { id: '5', type: 'job' as const, title: 'Product Manager', description: 'Lead product development and strategy', salary: '$90k-130k', position: { x: 900, y: 100 } },
      { id: '6', type: 'company' as const, title: 'Apple', description: 'Product management at Apple', position: { x: 1100, y: 100 } },
      { id: '7', type: 'skill' as const, title: 'Agile', description: 'Agile development methodologies', position: { x: 100, y: 300 } },
      { id: '8', type: 'skill' as const, title: 'Analytics', description: 'Data-driven decision making', position: { x: 300, y: 300 } },
      { id: '9', type: 'skill' as const, title: 'Leadership', description: 'Team management and communication', position: { x: 500, y: 300 } },
    ],
    edges: [
      { id: 'e1-2', source: '1', target: '2', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      { id: 'e2-3', source: '2', target: '3', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      ...
      { id: 'e4-5', source: '4', target: '5', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      { id: 'e5-6', source: '5', target: '6', sourceHandle: 'bottom', targetHandle: 'top', type: 'smoothstep' as const, animated: true },
      { id: 'e2-7', source: '2', target: '7', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
      { id: 'e3-8', source: '3', target: '8', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
      { id: 'e5-9', source: '5', target: '9', sourceHandle: 'right', targetHandle: 'left', type: 'smoothstep' as const },
    ]
  }
};
...
const mockAlternatives = {
  ...
  'data-scientist': [
    { id: 'alt1', title: 'Business Analyst', description: 'Analyze business data and processes', matchScore: 80, salary: '$60k-90k', requirements: ['Excel', 'SQL', 'Business Acumen'], growth: 'medium' },
    { id: 'alt2', title: 'Research Scientist', description: 'Conduct research in academia or industry', matchScore: 90, salary: '$70k-120k', requirements: ['PhD', 'Research Skills', 'Publications'], growth: 'high' },
    { id: 'alt3', title: 'Data Engineer', description: 'Build and maintain data pipelines', matchScore: 85, salary: '$80k-110k', requirements: ['Python', 'SQL', 'Cloud Platforms'], growth: 'high' }
  ],
  'product-manager': [
    { id: 'alt1', title: 'Project Manager', description: 'Manage projects and timelines', matchScore: 85, salary: '$70k-100k', requirements: ['PMP', 'Agile', 'Leadership'], growth: 'medium' },
    { id: 'alt2', title: 'Business Analyst', description: 'Analyze business requirements', matchScore: 80, salary: '$60k-90k', requirements: ['Analysis', 'Communication', 'Tools'], growth: 'medium' },
    { id: 'alt3', title: 'Marketing Manager', description: 'Lead marketing strategies and campaigns', matchScore: 75, salary: '$65k-95k', requirements: ['Marketing', 'Analytics', 'Creativity'], growth: 'high' }
  ]
};
